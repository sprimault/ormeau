 ...
 *
 * Rien n'est monté avant que la lecture ait abouti : une colonne écartée
 * pendant ce temps serait écrasée par le fichier à son arrivée, sans que rien
 * ne le signale. Le fichier est local, l'attente ne se voit pas.
 */
export function DecisionsProvider({ base, children }: ProprietesFournisseur) {
  ...
  return (
    <ContexteDecisions.Provider value={brouillon}>
      {brouillon.enCours ? null : children}
