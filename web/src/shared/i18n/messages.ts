...
const fr = {
  ...
  'anomaly.identite_invalide': 'Nature d’identité invalide',
  ...
  'warning.defaut_non_reporte': 'Défaut non reporté',
  'warning.collation_non_reportee': 'Collation non reportée',
  ...
  'warning.uuid_a_fournir': 'UUID à fournir',
...
const en: Record<MessageKey, string> = {
  ...
  'anomaly.identite_invalide': 'Invalid identity kind',
  ...
  'warning.defaut_non_reporte': 'Default not carried over',
  'warning.collation_non_reportee': 'Collation not carried over',
  ...
  'warning.uuid_a_fournir': 'UUID to supply',
