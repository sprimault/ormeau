...
$ docker run --rm --user "$(id -u):$(id -g)" \
    ...
    ghcr.io/sprimault/ormeau:v0.4.0 extraire --sortie /sortie/gescom.calque.json
```
...
$obtenu  = (Get-FileHash ormeau_v0.4.0_windows_amd64.zip -Algorithm SHA256).Hash.ToLower()
