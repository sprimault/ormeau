...
func sectionColonnesIgnorees(b *strings.Builder, d *Decisions) {
	...
	b.WriteString("#\n")
	b.WriteString("# Ce qui cite la colonne part avec elle : ses index, et l'association\n")
	b.WriteString("# d'une colonne de clé étrangère. La colonne reste en base, mais\n")
	b.WriteString("# migrations:diff proposera de la supprimer : à retirer du diff.\n")
	b.WriteString("#\n")
